// Iconos SVG simples y claros. Heredan el color con currentColor.
const base = {
  width: 24,
  height: 24,
  viewBox: '0 0 24 24',
...
export const IconoOjoCerrado = (p) => (
  <svg {...base} {...p}>
    <path d="M17.94 17.94A10 10 0 0 1 12 20C5 20 1 13 1 12a18 18 0 0 1 4-5m4-1a10 10 0 0 1 11 6 18 18 0 0 1-2 3m-7-9a3 3 0 0 1 3 3" />
...
export const IconoComoLlegar = (p) => (
  <svg {...base} {...p}>
